...
<section class="other_work1" id="other-work1" style="display:none;">
    ...
    <div class="portrait thumb" id="thumb_2"><?php echo do_shortcode('[nggallery id=3 images=0]');?></div>
	<?php
     $port = get_post(125);
...
<section class="other_work" id="other-work">
    ...
    <div class="portrait thumb" id="thumb_5"><?php echo do_shortcode('[nggallery id=7 images=0]');?></div>
<!--    <ul>
