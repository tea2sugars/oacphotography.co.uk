...
<!-- SOF OF HEADER -->
<header>
<div class="logo"><a href="<?php bloginfo( 'url' ); ?>"><img src="<?php bloginfo('template_url'); ?>/images/logo_bg.png" alt=""> <div class="logo_inner" style="height: 300px; margin-top: -3px; display: block;"><span class="logo_heading" style="margin-top:90px;"><img src="<?php bloginfo('template_url'); ?>/images/logo.png" alt="logo"/></span></div></a> </div>
<div class="names" style="display:none" id="welcomeDiv">images</div>

<div class="corporate-inner">CORPORATE</div>
