...
<div class="faqtext faqtext-portrait">
  ...
  <a href="#" class="slidesjs-previous slidesjs-navigation"><i class="icon-chevron-left"></i></a>
		...
		<div><?php echo do_shortcode($data['gallery_id'][0]);?></div>
...
<div class="slide corpo"><h1><?php $title=the_title();?></h1><p><?php echo $data['text'][0];?></p></div>
...
<div class="priceimage"><img src="<?php bloginfo('template_url'); ?>/images/por-right-image1.jpg"/></div> 
