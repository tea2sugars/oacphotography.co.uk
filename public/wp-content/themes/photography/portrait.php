...
<div class="responsive-slider flexslider"><ul class="slides">
	<?php
$args = array('post_type' => 'portrait_slider');
...
<div class="in-corporate">Portrait</div>
...
<article id="images_page" class="nav_border"><div class="celltitle"><h1>Portrait Photography</h1></div></article>
<!-- SOF of FAQ PAN -->
...
<div class="faqimage"><img src="<?php bloginfo('template_url'); ?>/images/por-left-image1.jpg"/></div>
<div class="faqtext price-corp image_corp">

<div class="ocarousel example_info" data-ocarousel-period="6000">
<?php
$args = array('post_type' => 'portrait_gallery');
$loop = new WP_Query( $args );
...
<div class="ocarousel example_info" data-ocarousel-period="6000">
<?php
$args = array('post_type' => 'portrait_content');
$loop = new WP_Query( $args ); 
if(count($loop->posts) > 1){
?>
<a href="#" data-ocarousel-link="left" class="slidesjs-previous" ></a>
...
<div class="priceimage"><img src="<?php bloginfo('template_url'); ?>/images/portncorp/port_about.png"/></div> 
...
<div class="faqimage"><img src="<?php bloginfo('template_url'); ?>/images/portncorp/port_price.png"/></div>
...
<div class="priceimage"><img src="<?php bloginfo('template_url'); ?>/images/portncorp/port-test.png"/></div> 
...
<section class="other_work">
    ...
    <div class="six column other_work_inner">
     <h4>Portrait</h4>
     <div class="corporate thumb" id="thumb_4"><?php echo do_shortcode('[nggallery id=7 images=0]');?></div>
