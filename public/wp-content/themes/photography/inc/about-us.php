...
<div id='mySwipe' style='max-width:100%;margin:0 auto' class='swipe'>
  <div class='swipe-wrap'>
	...
	<span style="float:right;"><a href="javascript::void(0);" onclick="mySwipe.next()">About Us</a></span>
	</b></div>
    <div><b>
   ...
   <div style="width:40%; margin-top:45px;" class="six column about_pan_left">
	...
	<span style="float:left;margin-left:21px;"><a style="font-size: 18px;font-weight: bold;" href="javascript::void(0);" onclick="mySwipe.prev()">About Us</a></span></div>
  </div>
</div>   
</section>
<!-- EOF OF ABOUT PAN -->
