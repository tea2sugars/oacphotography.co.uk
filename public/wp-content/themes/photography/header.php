...
var high = jQuery(".images_pan").height();
}
jQuery(".faq_pan").css("min-height",high);    
jQuery(".about_pan").css("min-height",parseInt(high)+40);  
jQuery(".prs_blg").css("min-height",high);  
jQuery(".how_we_work").css("min-height",high);
jQuery(".amigos").css("min-height",high);  
jQuery(".price_pan").css("min-height",high);
}else{
high = jQuery(".images_pan").height();
jQuery(".about_pan").css("min-height",'670px'); 
}
 })
</script>
