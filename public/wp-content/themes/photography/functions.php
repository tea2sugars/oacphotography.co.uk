...
function create_testmonial_taxonomies(){

register_taxonomy('testmonial_categories',array('testimonial'), array(
'hierarchical' => true,
    'labels' => array(
...
add_action( 'init', 'create_testmonial_taxonomies', 0 );

/*custom posttype for Testimonials */
...
/**Clients-content**********/
add_action( 'init', 'create_post_type_portrait_clients' );
function create_post_type_portrait_clients() {
	register_post_type( 'portrait_clients',
		array(
			'labels' => array(
	'name' => __( 'Clients' ),
